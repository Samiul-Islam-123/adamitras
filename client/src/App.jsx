...
const App = () => {
  useEffect(() => {
    ...
    return (
        <>
            <div className="fs z-20 w-full h-full bg-zinc-900 absolute top-0 left-0 flex items-center justify-center overflow-hidden">
            ...
            <div className="elem z-20 w-full h-0 bg-yellow-500 absolute bottom-0 left-0 flex items-center justify-center overflow-hidden">
